...
const summaryConfig = [
  ...
  { label: "Nuevos del Mes", key: "new_users_this_month", color: "text-purple-600", icon: <PersonAddIcon /> },
];
...
const DirectorDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header showMenu={true} showFullLogo={true} showSearch={false}
        navItems={[{ label: "Solicitudes", to: "/director/solicitudes" }, { label: "Usuarios", to: "/admin/usuarios" }, { label: "Coreografías", to: "/coreografias" }]}
        menuItems={[{ label: "Solicitudes de profesores", to: "/director/solicitudes" }, { label: "Usuarios", to: "/admin/usuarios" }]}
        rightActions={[
