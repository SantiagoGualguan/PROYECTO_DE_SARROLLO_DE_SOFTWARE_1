...
class VideoViewSet(viewsets.ModelViewSet):
    ...
    queryset = Video.objects.select_related("coreography").all()
    ...
    def list(self, request, *args, **kwargs):
        ...
        coreography_id = request.query_params.get("coreography") or request.query_params.get(
            "coreography_id"
        )
        if coreography_id:
            queryset = queryset.filter(coreography_id=coreography_id)
